            ...
            @foreach($galleryChunk as $gallery)
              <div class="col-12 col-md-4" data-aos="flip-left" data-aos-duration="1500">
                <div class="card" style="width: 18rem;">
                  <img src="{{ asset('foto_galeri/' . $gallery->foto) }}" class="card-img-top" alt="Foto {{ $gallery->nama }}" style="height: 280px; width: 100%;" />
                  <div class="card-body">
                    <p class="card-text">{{ $gallery->nama }}</p>
                  </div>
                </div>
              </div>
            @endforeach
